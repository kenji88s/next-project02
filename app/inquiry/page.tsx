...
export const metadata = {
  title: PagesInfo.contents["contact"]["title"]
};

export default function Page() {  
  return (
    <>
    <Common title={PagesInfo.contents["contact"]["title"]} subtitle={PagesInfo.contents["contact"]["ja"]}/>
      ...
      <div className="privacy_section_inner">
        <section className="privacy_set">
          <h2 className="privacy_set_title">1. 個人情報をお伺いする場合</h2>
          <div className="privacy_set_inner">
        ...
        <section className="privacy_set">
          <h2 className="privacy_set_title">2. 個人情報の管理・保護について</h2>
          <div className="privacy_set_inner">
        ...
        <section className="privacy_set">
          <h2 className="privacy_set_title">3. 個人情報の共同利用について</h2>
          <div className="privacy_set_inner">
            <p>私たちにご提供いただいた個人情報は、次の範囲で共同利用いたします。</p>
            <dl className="privacy_item">
        ...
        <section className="privacy_set">
          <h2 className="privacy_set_title">4. 個人情報開示について</h2>
          <div className="privacy_set_inner">
